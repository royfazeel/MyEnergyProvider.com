...
const CONFIG = {
    ...
    popupDelay: 0,              // Show immediately
    popupRecurDelay: 5000,      // Show again after 5 seconds
    particleCount: 50
};
    ...
    popup.innerHTML = `
        ...
        <div class="mega-popup-container">
            ...
            <div class="mega-popup-content">
                ...
                <p class="mega-popup-subtitle">Talk to a real person. Service fees apply.</p>
                ...
                <p class="mega-popup-disclaimer">Third-party service. Not affiliated with any utility. Fees apply.</p>
            </div>
        </div>
    `;
...
function closePopup() {
    ...
    if (popup) {
        ...
        popupTimer = setTimeout(showPopup, CONFIG.popupRecurDelay);
    }
}
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.scroll-animate, .stat-card, .area-card, .step-card, .provider-card').forEach(el => {
